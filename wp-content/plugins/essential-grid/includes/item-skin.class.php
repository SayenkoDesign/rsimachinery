...
class Essential_Grid_Item_Skin {
    ...
    public function output_item_skin($demo = false, $choosen_skin = 0){
		...
		$post_id_field = $this->post['ID'];	
		
		//$the_field=the_field( 'did_item_sell', $post_id_field );
		$the_field = get_field( "did_item_sell",$post_id_field , true );	
		if( $the_field != '' ){ echo '<div class="sold_out"></div>'; } else {echo '<div class="note_out"></div>';}
