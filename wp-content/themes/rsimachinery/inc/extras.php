...
function wpcharming_change_portfolio_labels( array $args ) {
    ...
    $labels = array(
        'name'               => __( 'Inventory', 'portfolioposttype' ),
        'singular_name'      => __( 'Item', 'portfolioposttype' ),
        'add_new'            => __( 'Add New Item', 'portfolioposttype' ),
        'add_new_item'       => __( 'Add New Product', 'portfolioposttype' ),
        'edit_item'          => __( 'Edit Item', 'portfolioposttype' ),
        'new_item'           => __( 'Add New Item', 'portfolioposttype' ),
        'view_item'          => __( 'View Item', 'portfolioposttype' ),
        'search_items'       => __( 'Search Inventory', 'portfolioposttype' ),
        'not_found'          => __( 'No Inventory found', 'portfolioposttype' ),
        'not_found_in_trash' => __( 'No Inventory found in trash', 'portfolioposttype' ),
    );
    $args['labels'] = $labels;
