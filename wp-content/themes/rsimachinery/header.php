							...
							<div class="header-extract clearfix">
								...
								<div class="extract-element">
									<div class="header-social">
										...
										<?php if ( !empty( $wpc_option['header_use_social']['email']) && $wpc_option['header_use_social']['email'] == 1 && $wpc_option['email'] !== '' ) { ?><a target="_blank" href="<?php echo wp_kses_post($wpc_option['email']); ?>" title="Email"><i class="fa fa-envelope"></i></a> <?php } ?>
									</div>
								</div>
								<?php } ?>
